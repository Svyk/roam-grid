...
const SETTING_DESCRIPTORS = [
  ...
  { key: "editing-native-editor", group: "Editing", name: "Edit cells with Roam's own block editor", description: "Open Roam's real block editor over the cell so [[, ((, #, {{ and / use Roam's own menus. Formula cells and the F2 editor still use the grid editor.", control: "switch", type: "bool", default: true, scope: "graph", apply: "immediate", stage: "live" },
  { key: "editing-autocomplete", group: "Editing", name: "Suggest functions and pages while typing", description: "Offer formula-function and [[page]] / ((block)) suggestions inside the cell editor.", control: "switch", type: "bool", default: true, scope: "graph", apply: "immediate", stage: "live" },
  ...
  { key: "editing-autocomplete-components", group: "Editing", name: "Complete {{components}} in cells", description: "Offer Roam components — TODO, query, embed, calc, video and the rest — when you type {{ in a cell.", control: "switch", type: "bool", default: true, scope: "graph", apply: "immediate", stage: "pending" },
  { key: "editing-autocomplete-commands", group: "Editing", name: "Offer / commands in cells", description: "Open a slash menu when you type / at the start of a cell or after a space.", control: "switch", type: "bool", default: false, scope: "graph", apply: "immediate", stage: "pending" },
  ...
  { key: EXPERIMENTAL_LARGE_GRID_KEY, group: "Experimental", name: "Large grids", description: "Allow creating and opening {{roam/grid}} large grids. Off by default. Existing files stay in the graph if you turn this off.", control: "switch", type: "bool", default: false, scope: "graph", apply: "immediate", stage: "live" },
  ...
  { key: "large-refs-sync", group: "Large grids", name: "Mirror large-grid references into Roam", description: "Write the distinct [[page]], #tag and ((block)) references from a large grid into collapsed blocks under it so Roam indexes them.", control: "switch", type: "bool", default: false, scope: "graph", apply: "next-op", stage: "experimental" },
