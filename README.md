...
4. After later builds, reload developer extensions through Roam MCP or with
   Roam's developer-extension reload shortcut.
...
- Drag across cells to select a rectangle. Drag headers to reorder, the header
  edge to resize, a selected range to move it, or the fill handle to repeat it.
